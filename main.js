...
const { AgCharts } = agCharts; // Assurez-vous que la bibliothèque AgCharts est chargée

const dateFormatter = new Intl.DateTimeFormat("en-US");

const tooltip = {
  renderer: ({ title, datum, xKey, yKey }) => {
    // Affichez les données du point survolé dans la console
    console.log("Données du point survolé:", datum);
    return {
      title,
...
const options = {
  container: document.getElementById("myChart"), // L'élément où le graphique sera inséré
  data: getData(), // Utilisez les données récupérées
  title: {
  ...
  axes: [
    {
      ...
      label: {
        format: "%b", // Format d'affichage des dates en abréviation (ex: Jan, Feb, ...)
      },
    },
    {
      position: "left",
...
// Créez le graphique avec les options définies
